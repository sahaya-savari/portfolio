...
- **Lighthouse Performance & Core Web Vitals Optimization**: **COMPLETED & VERIFIED**
  ...
  - **Mobile**: **98 / 100 / 100 / 100** (Accessibility: 100, Best Practices: 100, SEO: 100, FCP: 1.7s, LCP: 2.1s, TBT: 20–40ms, CLS: 0, Speed Index: 1.7s).
  - Inlined critical CSS directly into static pre-rendered HTML `<style id="critical-css">`, eliminating render-blocking stylesheet network roundtrips.
  - Consolidated all Barlow font weights (300/400/500/600 into preloaded `font-5.woff2`), saving 67 KB of render-blocking font downloads and eliminating un-preloaded `font-11.woff2`.
  - Slashed hero LCP render delay down to ~198ms.
  ...
  - Updated `/llms.txt` to strict llmstxt.org Markdown standard with `# Sahaya Savari F` H1, blockquote, and verified canonical Markdown links.
